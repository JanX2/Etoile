...
-(id) initWithFrame: (NSRect) frame
{
	...
	unifiedText = [[ArticleView alloc] initWithFrame: NSMakeRect(0, 0, 200, 200)];
    [unifiedText setAutoresizingMask: NSViewWidthSizable|NSViewHeightSizable];

	[self addSubview: unifiedText];
	[unifiedText release];
	return self;
}
...
- (void) setArticleView: (ArticleView *) _unifiedText
{
	unifiedText = _unifiedText;
}
