...
#if 0 // FIXME: not sure the range of #if
        /* ugly hack */
        if (scr->root_menu) {
...
#if 0 // Never used because WKF_SLOPPY is removed
static void
...
handleKeyPress(XEvent *event)
{
    ...
    if (command < 0) {
#if 1 //#ifdef LITE //FIXME: wRootMenuPerformShortcut is removed
        {
#if 0
        }
#endif
