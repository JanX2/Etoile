...
WDock *wDockRestoreState(WScreen *scr, NSDictionary *dock_state, int type);
...
void wDockSaveState(WScreen *scr, NSDictionary *old_state);
...
NSDictionary *wClipSaveWorkspaceState(WScreen *scr, int workspace);
WAppIcon *wClipRestoreState(WScreen *scr, NSDictionary *clip_state);
