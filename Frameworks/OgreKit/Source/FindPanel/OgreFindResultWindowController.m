...
- (void)setupFindResultView
{
	...
	headerCell = (NSTextFieldCell *)[[grepOutlineView tableColumnWithIdentifier:@"name"] headerCell];
	[headerCell setTitle:OgreTextFinderLocalizedString(@"Line")];
	headerCell = (NSTextFieldCell *)[[grepOutlineView tableColumnWithIdentifier:@"outline"] headerCell];
